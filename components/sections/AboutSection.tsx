    ...
    <div className="relative z-10 h-full w-screen flex   justify-center items-center pt-20  ">
      <div className="flex h-auto w-250 justify-center items-center gap-10  ">
        <div className="text-white max-w-150 flex flex-col ">
          ...
          <div
            className={`flex flex-col   overflow-hidden transition-all duration-500 ease-in-out origin-top ${showAbout ? 'max-h-[1000px] opacity-100  scale-y-100' : 'max-h-0 opacity-0 p-0 scale-y-0'}  lg:gap-2 lg:text-sm xl:gap-3 2xl:gap-4 2xl:text `}
          >
