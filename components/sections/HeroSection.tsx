...
export default function HeroSection() {
  return <header className="h-screen flex flex-col">
    <div className="w-screen relative z-1 -mt-20 left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] h-32 sm:h-40 md:h-48 lg:h-150">
      ...
      <div className="relative z-20 flex items-center justify-between h-full px-5 md:px-10 lg:px-20 -mt-10 ">
        ...
        <div className="flex items-center">
          <Image src={"/face.png"} alt="Thomas Cottiaux logo | KOTTIO logo" height={40} width={40} className="sm:h-[50px] sm:w-[50px] md:h-[80px] md:w-[80px] lg:h-[100px] lg:w-[100px]" ></Image>
    ...
    <div className="absolute z-10 flex flex-col md:flex-row mt-12 sm:mt-16 md:mt-40 justify-between items-start md:items-end w-screen gap-4 sm:gap-6 md:gap-0">
      ...
      <div className="pt-3 sm:pt-6 md:pt-5 pl-5 md:pl-10 lg:pl-20  flex flex-col ">
        ...
        <h1 className={`text-4xl md:text-6xl lg:text-8xl xl:text-9xl text-purple-500 xl:leading-28 ${bebas.className} line-he`}>FULL STACK  <br></br>DEVELOPER</h1>
      ...
      <div className="px-5 md:px-10 lg:px-20 flex flex-col md:flex-row gap-2 sm:gap-3 md:gap-5 w-full md:w-auto">
        <a
          href="#offers"
          className="border-1 px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-3 flex justify-center items-center text-sm sm:text-base md:text-xl lg:text-xl rounded border-neutral-800 hover:bg-gray-100 transition-colors cursor-pointer"
        >
          <span>MY OFFERS</span>
        </a>
        <a
          href="#projects"
          className="border-1 px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-3 flex justify-center items-center text-sm sm:text-base md:text-xl lg:text-xl bg-purple-500 text-white rounded hover:bg-purple-600 transition-colors cursor-pointer"
        >
